...
public class SecurityConfig {
        ...
        public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
                http.authorizeHttpRequests(auth -> auth
                                ...
                                .requestMatchers("/giangvien/trang-giang-vien")
                                .hasAnyRole("GIANGVIEN")
                                ...
                                .rememberMe(remember -> remember.rememberMeParameter("remember-me") // phải
                                                                                                    // giống
                                                                                                    // tên
                                                                                                    // trong
                                                                                                    // checkbox
                                                ...
                                                .userDetailsService(userDetailsService) // quan
                                                                                        // trọng
                                )
