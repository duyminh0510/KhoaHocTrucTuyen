...
public class HoaDonPDFGenerator {
    ...
    public static byte[] taoHoaDonPDF(String tenHocVien, String giaoDichId, String tongTien, List<String> danhSachKhoaHoc) throws Exception {
        Document document = new Document(PageSize.A4);
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        ...
        // Font hỗ trợ tiếng Việt
        BaseFont bf = BaseFont.createFont("src/main/resources/fonts/arial-unicode-ms.ttf", BaseFont.IDENTITY_H, BaseFont.EMBEDDED);
        Font fontTieuDe = new Font(bf, 18, Font.BOLD);
        Font fontChu = new Font(bf, 12);
