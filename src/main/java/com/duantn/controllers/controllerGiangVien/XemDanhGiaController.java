...
public class XemDanhGiaController {
    ...
    public String xemDanhGiaTongQuan(
            ...
            Model model,
            @AuthenticationPrincipal CustomUserDetails currentUser // ✅ sửa ở đây
    ) {
        ...
        // Lấy tất cả khóa học thuộc giảng viên hiện tại
        ...
        // Nếu đã chọn một khóa học cụ thể
        if (khoahocId != null) {
            ...
            // Nếu chưa chọn khóa học nào -> hiển thị tổng quan theo từng khóa học
        ...
        return "views/gdienGiangVien/quan-ly-danh-gia"; // ✅ Dùng 1 giao diện duy nhất
    }
}
