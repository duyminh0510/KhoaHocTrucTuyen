...
public class ViGiangVienController {
    ...
    public String xemVi(Model model, @AuthenticationPrincipal CustomUserDetails customUserDetails) {
        ...
        return "views/gdienChung/templateChung"; // Đây là layout cha
    }
    ...
    public String guiYeuCauRutTien(@RequestParam("soTienRut") BigDecimal soTienRut,
        ...
        RutTienGiangVien yeuCau = RutTienGiangVien.builder()
                .taikhoanGV(taikhoan)
                .soTienRut(soTienRut)
                .tenGiangVien(taikhoan.getName())
                .trangthai(TrangThaiRutTien.DAGUI_YEUCAU)
                .ngayrut(LocalDateTime.now())
                .build();
