...
public class ThanhToanController {
    ...
    public static class ThanhToanVM {
        ...
        public ThanhToanVM(Integer id, String tenHocVien, String email, String ngayThanhToan, String hinhThuc,
    ...
    private List<ThanhToanVM> listThanhToan() {
        return Arrays.asList(
                new ThanhToanVM(1, "Nguyễn Văn A", "a@gmail.com", "01/06/2024 10:00", "VNPAY",
                        new BigDecimal("1500000"), "THANH_CONG", "Java Cơ bản", "GD001", "Thanh toán thành công"),
                new ThanhToanVM(2, "Trần Thị B", "b@gmail.com", "02/06/2024 14:30", "MOMO", new BigDecimal("1200000"),
                        "DANG_CHO", "Spring Boot Mastery", "GD002", "Chờ xác nhận"),
                new ThanhToanVM(3, "Lê Văn C", "c@gmail.com", "03/06/2024 09:15", "VNPAY", new BigDecimal("900000"),
